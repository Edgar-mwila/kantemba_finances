...
class _BalanceSheetScreenState extends State<BalanceSheetScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final outstandingReceivables = receivablesProvider.receivables
        .where((r) => r.status == 'active')
        .fold<double>(0.0, (sum, r) => sum + r.principal);
    final outstandingPayables = payablesProvider.payables
        .where((p) => p.status == 'active')
        .fold<double>(0.0, (sum, p) => sum + p.principal);
    final outstandingLoans = loansProvider.loans
