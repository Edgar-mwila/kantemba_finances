                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: const [
                            Expanded(flex: 3, child: Text('Return ID', style: TextStyle(fontWeight: FontWeight.bold))),
                                ...
                                itemBuilder: (ctx, i) {
                                  ...
                                  return InkWell(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text('Return Details', style: Theme.of(context).textTheme.titleLarge),
                                                        IconButton(
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          const SizedBox(width: 8),
                                                          Text('Status: ${returnItem.status.toUpperCase()}', style: TextStyle(color: statusColor, fontWeight: FontWeight.bold)),
                                                        ],
                                                      ),
                                                    ),
                                                    const SizedBox(height: 16),
                                                    Text('Returned Items:', style: Theme.of(context).textTheme.titleMedium),
                                                            ...
                                                            child: ListTile(
                                                              ...
                                                              trailing: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text('= K${item.totalAmount.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                                                                ],
                                                              ),
                                                            ),
                                                          );
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              const Text('Total Return:', style: TextStyle(fontWeight: FontWeight.bold)),
                                                              Text('K${returnItem.grandReturnAmount.toStringAsFixed(2)}', style: const TextStyle(fontWeight: FontWeight.bold)),
                                                            ],
                                                          ),
                                                        ],
                                                      ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Expanded(flex: 3, child: Text(returnItem.id)),
                                          Expanded(flex: 2, child: Text(returnItem.date.toIso8601String())),
                                          Expanded(flex: 2, child: Text(shop.name, style: TextStyle(color: Colors.grey.shade600, fontSize: 12)) ),
                                          Expanded(flex: 2, child: Row(children: [Icon(statusIcon, color: statusColor, size: 16), const SizedBox(width: 4), Text(returnItem.status.toUpperCase(), style: TextStyle(color: statusColor, fontWeight: FontWeight.bold, fontSize: 12))])),
                                          Expanded(flex: 2, child: Text('K${returnItem.grandReturnAmount.toStringAsFixed(2)}')),
                                        ],
                                      ),
                                    ),
                                  );
