...
class _NewInventoryModalState extends State<NewInventoryModal> {
        ...
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('Add Inventory Purchase', style: Theme.of(context).textTheme.headlineSmall),
                Autocomplete<String>(
                  ...
                  onSelected: (String selection) {
                    setState(() {
                      ...
                      final item = existingItems.firstWhere((e) => e.name == selection);
                    ...
                    return TextFormField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          if (_isExistingItem) {
                            final item = existingItems.firstWhere((e) => e.name == value);
                            _selectedItemId = item.id;
                            _lowStockThreshold = item.lowStockThreshold;
                          } else {
                ...
                TextFormField(
                  decoration: const InputDecoration(labelText: 'Bulk Price (total purchase)'),
                ...
                TextFormField(
                  decoration: const InputDecoration(labelText: 'Unit Sale Price'),
                  keyboardType: TextInputType.numberWithOptions(decimal: true),
                  validator: (value) {
                ...
                TextFormField(
                  ...
                  onSaved: (value) {
                    if (value != null && value.isNotEmpty) {
                      final parsed = int.tryParse(value);
                      if (parsed != null && parsed > 0) _lowStockThreshold = parsed;
                    }
                  },
  ...
  void _submit() async {
    ...
    if (_isExistingItem && _selectedItemId != null) {
      ...
      await inventoryProvider.increaseStockAndUpdatePrice(_selectedItemId!, _units, _unitPrice);
    } else {
      ...
      await inventoryProvider.addInventoryItem(newItem, currentUser.id);
    }

    // Add bulk purchase as expense
    final expense = Expense(
      id: '', // Will be set by provider
      description: 'Bulk purchase: $_itemName${_description.isNotEmpty ? ' - $_description' : ''}',
      amount: _bulkPrice,
      date: DateTime.now(),
      category: 'Purchases',
      createdBy: currentUser.id,
